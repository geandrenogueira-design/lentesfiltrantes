...
// ─── Monosílabos em Português (Wilkins Rate of Reading Test) ───────────────
// Palavras de alta frequência, monossilábicas, sem contexto narrativo previsível.
// Critério: comuns no português brasileiro escrito e falado.
const READING_WORDS = [
  "o",  "a",   "e",   "em",  "um",
  "ao", "eu",  "já",  "lá",  "faz",
  "vez","voz", "luz", "paz", "foi",
...
export default function App() {
  ...
  const ReadingTest = ({ phase }) => {
    ...
    // Triplica a lista para garantir que não falte palavras durante o teste
        ...
        {!isReading ? (
          <>
            ...
            <p style={{ fontSize:"0.88rem", color:"var(--text-muted)", margin:"0 0 1.5rem" }}>
              ...
              Toque em <strong>Iniciar</strong> e registre cada palavra correta com <strong style={{color:"var(--success)"}}>+</strong>.
            </p>
      ...
      <div className="screen">
        ...
        <div className="steps-list">
          {[
            ...
            ["Teste de Leitura Base",     "Velocidade sem filtro — monossilabos em português (pal/min)"],
    ...
    4: (
      <div className="screen">
        ...
        <p className="screen-subtitle">
          Wilkins Rate of Reading Test — monossilabos em português, sem filtro
        </p>
        <div className="card" style={{ marginBottom:"1.25rem", background:"#f0f5fb", border:"1px solid #c0d5ec" }}>
          <div className="card-title" style={{ color:"var(--accent)" }}>Lista de palavras</div>
          <div style={{
        ...
        <div className="screen">
          ...
          <div className="metrics-row">
            ...
            <div className="metric-card">
              <div className="metric-val"
                style={{ color: improvement>=0 ? "var(--success)" : "var(--danger)" }}>
          ...
          <div className="card">
            ...
            <p style={{ fontSize:"0.9rem", lineHeight:1.75, color:"var(--text-muted)" }}>
              ...
              de ajuste em 3–6 meses conforme adaptação cortical. Reavaliar se houver mudança da queixa
